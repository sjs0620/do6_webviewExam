package com.sjs.do6_webviewexam;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //WebView 설정자바스크립트를 설정해준다 하지 않으면
        //자바스크립트를 설정해준다 하지 않으면 naver같은 page에서 보이지않을수 있다.
        //https://~  http://에서 실행되지 않으면 manifest에서
        //       android:usesCleartextTraffic="true"하면 해결할수 있으나 앱의 보안도 믿을수 없게되므로 https://로 하자
